  ...
  return (
    <div className="bg-gray-900 rounded-xl border border-orange-600/20 overflow-hidden">
      <div className="flex items-center gap-2 px-6 py-4 border-b border-orange-600/20">
        ...
        <h2 className="font-semibold text-white">Draft Settings</h2>
      </div>

      <form onSubmit={handleSave} className="divide-y divide-orange-600/10">
        ...
        <div className="p-6 space-y-4">
          ...
          <div className="flex justify-between text-xs text-gray-600 -mt-2">
            <span>Off</span><span>15 min</span><span>30 min</span><span>1 hr</span><span>2 hr</span>
          </div>
          ...
          {!hasPauseColumns && (
            <div className="bg-yellow-950/40 border border-yellow-700/40 rounded-lg p-3 text-xs text-yellow-300 space-y-1">
              ...
              <p className="text-yellow-500">
                Run <code className="bg-gray-900 px-1 py-0.5 rounded">003_overnight_pause.sql</code> in your Supabase SQL Editor, then reload this page.
              </p>
            </div>
          )}
          ...
          {hasPauseColumns && settings.overnight_pause_enabled && (
            <div className="space-y-4 pl-6 border-l-2 border-blue-500/30">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-medium text-gray-400 mb-1">Pause begins (CT)</label>
                  <select
                ...
                <div>
                  <label className="block text-xs font-medium text-gray-400 mb-1">Draft resumes (CT)</label>
                  <select
              ...
              <div className={`flex items-center gap-2 p-3 rounded-lg border text-sm ${
                ...
                <span>
                  ...
                  {currentlyPaused ? ' · 🌙 Currently in pause window' : ' · Draft active right now'}
                </span>
              </div>
